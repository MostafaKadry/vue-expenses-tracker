    ...
    <div class="flex items-center justify-center my-4">
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full">
        ...
        <form @submit.prevent="handleSubmit" class="px-6 py-4">
          ...
          <!-- Amount -->
          <div class="mb-4">
            <label for="amount" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Amount (L.E)</label>
      ...
      editingTransaction: {
        ...
        handler(newVal) {
          if (newVal) {
            this.form = {
              ...newVal,
              date: newVal.date.split('T')[0] // Format date for input
            }
          } else {
            this.resetForm()
          }
